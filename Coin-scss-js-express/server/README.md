# Бэкенд к итоговой работе «Разработка банковской системы над криптовалютными средствами»

p.s. Backend(часть) сервер - разрабатывался не мной, а была взята в свободном доступе на Git.
